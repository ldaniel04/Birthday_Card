...
fun GreetingImage(message: String, from: String, modifier: Modifier = Modifier){
    //Esta funcion carga un recurso imagen y toma el ID del recurso
...
fun BirthdayCardPreview() {
    Birthday_CardTheme {
        GreetingImage(stringResource(R.string.happy_birthday_text), stringResource(R.string.from_baki))
    }
}